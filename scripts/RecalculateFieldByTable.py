...
class RecalculateFieldByTable(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Set Geometry to Match Reference Layer"
        self.description = "This tool accepts looks up each value from the Target Feature Class Lookup Field, " \
                           "finding a matching record in the Reference Feature Class Reference Field. It will then " \
                           "write the Reference Feature Class Return Field to the Target Feature Class Target Field."
